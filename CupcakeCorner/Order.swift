...
class Order: ObservableObject, Codable {
    ...
    var hasValidAddress: Bool {
        if validateAddress(name: name, streetAddress: streetAddress, city: city, zip: zip) {
            return true
        }
    ...
    func validateAddress(name: String, streetAddress: String, city: String, zip: String) -> Bool {
